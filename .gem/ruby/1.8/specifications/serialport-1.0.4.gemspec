...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "CHANGELOG", "LICENSE", "MANIFEST", "README", "Rakefile", "VERSION", "ext/native/extconf.rb", "ext/native/posix_serialport_impl.c", "ext/native/serialport.c", "ext/native/serialport.h", "ext/native/win_serialport_impl.c", "lib/serialport.rb", "serialport.gemspec", "test/miniterm.rb", "test/set_readtimeout.rb"]
  s.homepage = %q{http://github.com/hparra/ruby-serialport/}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.5}
  s.summary = %q{Library for using RS-232 serial ports.}
  s.test_files = ["test/miniterm.rb", "test/set_readtimeout.rb"]
